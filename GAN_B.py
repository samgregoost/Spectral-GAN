...
class GAN_B:
    ...
    def inference(self):
        self.saver.restore(sess, ".Models/modelb" + str(self.fband) + ".ckpt")
    ...
    def train(self):
        ...
        for i in range(self.nepochs):
            ...
            for idx in xrange(0, batch_idxs):
                ...
                if self.fband > 1:
                    condition1 = np.reshape(X_batch, (1, -1))[:, 50*50*2*(self.band):50*50*2*(self.band+1)]
               # condition2 = np.reshape(X_batch, (1,-1))[:,50*50*2*2:50*50*2*2]
         ...
         #   X_batch = sample_data(n=10)
            ...
            #    sess.run(d_clip)
               ...
               # print(X_batch_)
                ...
                if itr%100==0:
                    print("saving model")
                    saver.save(sess, ".MODELS/modelb" + str(self.fband) + ".ckpt")
                print(itr)
                print(dloss)
                print(gloss)
